...
public class ApplicationControllerTest {
    ...
    public void getAllApplications_ShouldReturnList() throws Exception {
        ...
        CompanyResponse company = new CompanyResponse(UUID.randomUUID(), "Company A", "website.com", "linkedin.com",
                "logo.png", LocalDateTime.now());
        ApplicationResponse appResp = new ApplicationResponse(randomId, company, "Dev", ApplicationStatus.APPLIED,
